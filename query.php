...
<?php
     ...
     $dbname="evento_signup";
      ...
      $result = mysqli_query($connector,"SELECT * FROM contact_us ");
      ?>
      <!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="table" style="height:100vh;background-attachment:fixed;width:100%">
      ...
      <br>
      <div class="hr1"><h2>User Queries</h2></div></br>
      <thead>
    ...
    <td><a href="delete_query.php?id=<?php echo $row['id']; ?>">Delete</a></td>
  </tr>	
<?php
        }
        ?>
      ...
      <div class="back"><a href="admin/home.php"><button> Back <i class="fa fa-sign-out"></i></button></a></div>
        </div>
     </div>
        </div>
    </body>
