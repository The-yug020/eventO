...
<?php
     ...
     $dbname="evento_signup";
      ...
      $result = mysqli_query($connector,"SELECT * FROM book WHERE event='$id' ");
...
<body>
    ...
    <div class="table" style="height:100vh;background-attachment:fixed;width:100%">
      ...
      <br>
      <div class="hr1"><h2>Audience List</h2></div></br>
      <thead>
...
<?php
      ...
      <div class="back"><a href="myevents.php"><button> Back <i class="fa fa-sign-out"></i></button></a></div>
        </div>
     </div>
        </div>
    </body>
