...
$query2=mysqli_query($conn,"SELECT id,venue FROM venue order by venue");
    ...
    <form method="post" enctype="multipart/form-data">
             <div class="banner11">
              ...
              <div class="item">
                <p>Venue Name</p>
                <?php
                if($r_set = $conn->query("SELECT id,venue,address from venue order by venue")){

                  echo "<select id=venue name=venue class='form-control' style='width:230px;'>";
              ...
              <div class="item">
                <p>Venue Address</p>
                <?php
                if($r_set = $conn->query("SELECT id,venue,address from venue ")){

                  echo "<select id=address name=address class='form-control' style='width:230px;'>";
                  while ($row = $r_set->fetch_assoc()) {
